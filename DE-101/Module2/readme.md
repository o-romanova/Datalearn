...
Спасибо большое Ruslan, Daniel и Yurii Z за комментарии по коду, это уже как минимум третья и значительно оптимизированная версия.
...
Ну и так далее. Скрипт с несколькими оставшимися показателями можно посмотреть [тут](Datalearn/DE-101/Module2/sql-queries_superstore-db.sql)
